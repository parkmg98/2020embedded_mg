...
머리x왼쪽턴10_LOOP:
    ...
    ERX 4800,A,머리x왼쪽턴10_LOOP	'예)환자및구역찾아신호를보냄
    DELAY 300
    GOTO RX_EXIT
...
머리x오른족턴10_LOOP:
    ...
    ERX 4800,A,머리x오른족턴10_LOOP	'예)환자및구역찾아신호를보냄
    DELAY 300
    GOTO RX_EXIT
...
머리x왼쪽턴20_LOOP:
    ...
    ERX 4800,A,머리x왼쪽턴20_LOOP	'예)환자및구역찾아신호를보냄
    DELAY 300
    GOTO RX_EXIT
...
머리x오른족턴20_LOOP:
    ...
    ERX 4800,A,머리x오른족턴20_LOOP	'예)환자및구역찾아신호를보냄
    DELAY 300
    GOTO RX_EXIT
...
뒤로돌기머리x왼쪽턴20_LOOP:
    ...
    보행COUNT = 보행COUNT + 1
    IF 보행COUNT > 턴횟수 THEN  GOTO RX_EXIT
    ELSE GOTO 뒤로돌기머리x왼쪽턴20_LOOP
...
한번연속전진_1:
    ...
    보행COUNT = 보행COUNT + 1
    IF 보행COUNT = 보행횟수 THEN  GOTO 한번연속전진_1stop
...
한번연속전진_3:
    ...
    보행COUNT = 보행COUNT + 1
    IF 보행COUNT = 보행횟수 THEN  GOTO 한번연속전진_2stop
...
한번팔x연속전진_1:
    ...
    보행COUNT = 보행COUNT + 1
    IF 보행COUNT > 보행횟수 THEN  GOTO 한번팔x연속전진_1stop

    ERX 4800,A, 한번팔x연속전진_2
    IF A = 30 THEN
        GOTO 한번팔x연속전진_2
    ELSE
        ' GOSUB Leg_motor_mode3
...
한번팔x연속전진_3:
    ...
    보행COUNT = 보행COUNT + 1
    IF 보행COUNT > 보행횟수 THEN  GOTO 한번팔x연속전진_3stop

    ERX 4800,A, 한번팔x연속전진_4
    IF A = 30 THEN
        GOTO 한번팔x연속전진_4
    ELSE
한번팔x연속전진_3stop:
